...
//// $> ls -l || pwd ; ls ; pwd
static t_pars_list			*test20(void)
{
	t_pars_list		*list0, *list1, *list2, *list3;

	if (!(list0 = (t_pars_list *)malloc(sizeof(t_pars_list))))
		return (error_list());
	if (!(list0->pars_args = (char **)malloc((sizeof(char *) * 3))))
		return (error_list());
	list0->name_run_func[0] = '\0';
	list0->pars_args[0] = ft_strdup("ls");
	...
	if (!(list1 = (t_pars_list *)malloc(sizeof(t_pars_list))))
		return (error_list());
	if (!(list1->pars_args = (char **)malloc((sizeof(char *) * 2))))
		return (error_list());
	list1->name_run_func[0] = '\0';
	...
	if (!(list2 = (t_pars_list *)malloc(sizeof(t_pars_list))))
		return (error_list());
	if (!(list2->pars_args = (char **)malloc((sizeof(char *) * 2))))
		return (error_list());
	list2->name_run_func[0] = '\0';
	...
	if (!(list3 = (t_pars_list *)malloc(sizeof(t_pars_list))))
		return (error_list());
	if (!(list3->pars_args = (char **)malloc((sizeof(char *) * 2))))
		return (error_list());
	list3->name_run_func[0] = '\0';
	list3->pars_args[0] = ft_strdup("pwd");
	list3->pars_args[1] = NULL;
	list3->name_func = list3->pars_args[0];
	list3->status = 0;
...
/***********старые тесты**************/
	...
	list = test21();		// $> ls -l && ls | wc -l | cat -e
	buflist = list;
	{
		ft_putstr("\n\n\n16>>> ls -l && ls | wc -l | cat -e\n");
		ft_putstr("nid>> {{вывод ls и труб}}\n");
...
void	comdo3()
{
	...
	list = test20();		// $> ls -l || pwd ; ls ; pwd
	buflist = list;
	{
		ft_putstr("\n\n\n16>>> ls -l || pwd ; ls ; pwd\n");
		ft_putstr("nid>> {{вывод ls -l, ls, pwd}}\n");
		check_choice(execlist, &buflist);
		free_pars_list(list);
	}
}